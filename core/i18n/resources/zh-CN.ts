...
export const zhCN = {
  ...
  sidepanel: {
    ...
    settings: {
      ...
      expertModeDescription: '仅影响 chat.deepseek.com 网页对话；侧边栏 API 对话在对话页选择模型。（B-01）当网页已上传文件或已手动选过模型时不会强制切换。',
      sidepanelChat: '侧边栏对话',
      ...
      shellHostNameHint: '仅在本地 unpacked 构建且 shell host 安装时用了不同名称时需要改。默认：com.deepseek_pp.shell',
      shellHostSaved: '已保存。后续新建的 MCP server 会用这个名称。',
      shellHostCleared: '已清除，会用默认名称（com.deepseek_pp.shell）。',
