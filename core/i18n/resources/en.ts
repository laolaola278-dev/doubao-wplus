...
export const en = {
  ...
  sidepanel: {
    ...
    settings: {
      ...
      shellHostNameHint: 'Override only if you are running a local unpacked build and installed the shell host under a different name. Default: com.doubao_pp.shell',
      shellHostSaved: 'Saved. New MCP server presets will use this host name.',
      shellHostCleared: 'Cleared. The default host name (com.doubao_pp.shell) will be used.',
