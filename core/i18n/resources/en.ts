...
export const en = {
  ...
  sidepanel: {
    ...
    settings: {
      ...
      expertModeDescription: 'Only affects chat.deepseek.com conversations. Sidepanel API chat chooses the model on the Chat page. (B-01) Skipped when you upload files or have already picked a model in the web UI.',
      ...
      shellHostNameHint: 'Override only if you are running a local unpacked build and installed the shell host under a different name. Default: com.deepseek_pp.shell',
      shellHostSaved: 'Saved. New MCP server presets will use this host name.',
      shellHostCleared: 'Cleared. The default host name (com.deepseek_pp.shell) will be used.',
