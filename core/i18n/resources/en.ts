...
export const en = {
  ...
  manifest: {
    name: 'WPlus',
    description: 'Agentic memory, skills, execution, automation, and MCP tools for Doubao',
    actionTitle: 'WPlus',
  },
  app: {
  ...
  locale: {
    ...
    settingDescription: 'Choose the language for WPlus UI and model behavior.',
    auto: 'Follow browser',
    zhCN: '简体中文',
    en: 'English',
  },
  sidepanel: {
    ...
    githubSkillImport: {
      ...
      description: 'Supports repositories, directories, and single SKILL.md links. WPlus previews content before import and never overwrites local custom Skills.',
    ...
    localSkillImport: {
      ...
      description: 'Reads a local Skill folder through Shell MCP. WPlus keeps the folder reference and never executes scripts during import.',
    ...
    projectsPage: {
      title: 'Projects',
      description: 'Add Doubao conversations to projects. Project instructions and project memories are injected for those conversations.',
      ...
      empty: 'No projects',
      emptyHelp: 'Create a project, then add the current Doubao conversation or assign the next new conversation to it.',
      ...
      noCurrentConversation: 'The active tab is not a Doubao conversation.',
    ...
    whatsNew: {
      ...
      dismiss: 'Got it',
      items: {
        browserControl: 'Browser Control can select a target tab from the side panel and perform visible web actions for WPlus.',
    ...
    memoryPage: {
      title: 'Memory',
      description: 'Manage the preferences, feedback, topic context, and references that influence future WPlus replies.',
      ...
      emptyHelp: 'WPlus saves durable preferences and project context from conversation, and you can add entries manually.',
      count: '{count} memories total',
    },
    ruleEngine: {
      title: 'Rule Engine',
      description: 'Declarative rules: automatically enhance prompts by condition (enable skills, inject memories, switch presets, append text, block sending, etc.).',
      count: '{count} rules, {enabled} enabled',
      create: 'New rule',
      empty: 'No rules yet',
      emptyHelp: 'A rule = conditions + actions. E.g. auto-enable the Python skill when the prompt contains "Python".',
      priority: 'Priority {value}',
      stopOnMatch: 'Stop on match',
      conflicts: '{count} potential conflicts detected',
      noConflicts: 'No conflicts',
      log: 'Execution log',
      logEmpty: 'No executions yet — send a message then refresh',
      logBlocked: 'Blocked',
      logMatched: 'Matched {count} rules',
      logNoMatch: 'No rules matched',
      logPromptLength: '{before}→{after} characters',
      clearLog: 'Clear log',
      editorName: 'Rule name',
      editorPriority: 'Priority (lower runs first)',
      editorMatch: 'Condition combination',
      editorMatchAll: 'All must match (AND)',
      editorMatchAny: 'Any may match (OR)',
      editorConditions: 'Conditions (JSON array)',
      editorActions: 'Actions (JSON array)',
      editorStopOnMatch: 'Stop later rules on match',
      editorSave: 'Save rule',
      editorCancel: 'Cancel',
      editorInvalid: 'Rule validation failed: {errors}',
      editorHint: 'Condition kinds: keyword / regex / length / host / url / time / session / memory-hit / attachment / variable; action kinds: enable-skill / inject-memory / append-prompt / replace-prompt / set-preset / block-send / confirm-send / log-diagnostics',
      variables: 'Custom variables',
      variablesHint: 'Variables for variable conditions (key=value per line)',
      variablesSave: 'Save variables',
    },
    studio: {
      navLabel: 'Studio sub-navigation',
      tabs: {
        overview: 'Overview',
        prompt: 'Prompt',
        memory: 'Memory',
      ...
      overview: {
        ...
        memoryHitsHint: '{uses} injections',
        skillUses: 'Skill uses',
        host: 'Host',
        healthScore: 'Health Score',
        healthScorePending: 'N/A',
        healthScoreHint: 'Health scoring coming soon',
        selfCheck: 'Self-check',
        selfCheckPassed: 'All passed',
        selfCheckIssues: '{errors} errors · {warns} warnings',
        noHostTab: 'No host page detected',
        recentDiagnostics: 'Recent diagnostics',
        recentEmpty: 'No diagnostics yet — send a message and come back',
        ruleBlocked: 'Rule blocked send',
        ruleMatched: '{count} rules matched',
      },
      prompt: {
        noHostTab: 'No host page detected — open Doubao or DeepSeek, then refresh',
        inspectorDisabled: 'Prompt snapshot capture is dev-build only (zero overhead in production)',
        empty: 'No prompt snapshots yet — send a message and refresh',
        fullTextHint: 'For full prompt text, press Ctrl+Shift+P on the host page to open the Inspector panel',
        lastAugmentMs: 'Last augment time',
        lastExpansion: 'Last length change',
        memories: '{count} memories',
        augmentFailed: 'augment failed',
        stageUnchanged: 'unchanged',
      },
      diagnostics: {
        selfCheckTitle: 'Startup self-check',
        devOnly: 'Self-check reports are generated in dev builds only',
        ruleLogTitle: 'Rule execution log (last 10)',
      },
      settings: {
        dataTitle: 'Statistics data',
        dataSummary: '{days} daily buckets recorded, {prompts} prompts total',
        cleared: 'Statistics cleared',
        devToolsTitle: 'Developer tools',
        devToolsHint: 'Prompt Inspector (Ctrl+Shift+P on host page) and diagnostics export (__DWPLUS_EXPORT_DIAG__) are available in dev builds only.',
      },
    },
    insights: {
      title: 'AI Insights',
      description: 'Local statistics of your AI usage: prompts, memory, skills, presets, hosts and performance.',
      privacyNote: 'All data stays local — nothing uploaded, no content collected, anonymous by default',
      range: {
        today: 'Today',
        week: 'This week',
        month: 'This month',
      ...
      empty: 'No data yet — send a message and come back',
      cardPrompts: 'Prompts sent',
      cardMemoryHitRate: 'Memory hit rate',
      cardMemoryHitHint: '{hits} hits · {uses} injections',
      cardSkillHitRate: 'Skill hit rate',
      cardSkillHitHint: '{hits} hits',
      cardPresetUses: 'Preset uses',
      cardAvgLength: 'Avg prompt length',
      cardMaxLength: 'Max {max} chars',
      trend: 'Send trend',
      hosts: 'Host breakdown',
      topSkills: 'Top skills',
      topMemories: 'Most used memories',
      deletedMemory: 'Deleted memory #{id}',
      ...
      perfMax: 'Max',
      perfCount: 'Count',
      perfAugment: 'Prompt augmentation',
      perfMemory: 'Memory lookup',
      perfRules: 'Rule engine',
      exportJson: 'Export JSON',
      exportCsv: 'Export CSV',
      clear: 'Clear data',
      clearConfirm: 'Clear all statistics? This cannot be undone.',
      weekdays: {
        mon: 'Mon',
        tue: 'Tue',
        wed: 'Wed',
    ...
    memoryStudio: {
      searchPlaceholder: 'Full-text search (name/content/tags)',
      allTags: 'All tags',
      sortUpdated: 'By updated time',
      sortCreated: 'By created time',
      sortHits: 'By hit count',
      sortRecentUse: 'By recent use',
      selectAll: 'Select all',
      deleteSelected: 'Delete selected ({count})',
      deleteSelectedConfirm: 'Delete {count} selected memories? This cannot be undone.',
      import: 'Import',
      export: 'Export',
      importSuccess: 'Imported {count} memories',
      importFailed: 'Import failed: {error}',
      analysis: 'Hit analysis',
      analysisPrompt: 'Enter a prompt to see which memories it would hit',
      analysisRun: 'Analyze',
      analysisSelected: 'Hit {selected}/{total} (budget {budget} tokens)',
      analysisContribution: 'Injected content',
      analysisNotSelected: 'Not selected',
      analysisKeywords: 'Keywords: tags [{tags}] · name [{name}] · content [{content}]',
      analysisScore: 'Score {score} (keyword {keyword} + activity {decay}{pinned})',
      analysisPinnedNote: ' + pinned 1000',
      health: 'Health check',
      healthRun: 'Run check',
      healthClean: 'No issues found across {count} memories',
      healthSummary: 'Checked {count}: duplicates {duplicate} · stale {stale} · oversized {oversized} · conflicts {conflict}',
      healthSuggestionMerge: 'Suggest merging',
      healthSuggestionReview: 'Suggest manual review',
      healthSuggestionDeleteOrPin: 'Suggest delete or pin to keep',
      healthSuggestionShorten: 'Suggest shortening',
      sourceUser: 'Manual',
      sourceAiTool: 'AI saved',
    ...
    skillPage: {
      ...
      usageSuffix: 'in the Doubao input to trigger a Skill. Example:',
    ...
    settings: {
      ...
      apiKeyRequired: 'Enter a Doubao API Key',
      saveFailed: 'Save failed',
      clearFailed: 'Clear failed',
      apiKeySaved: 'Saved. Context menu scenarios can now run on regular webpages.',
      apiKeyCleared: 'Cleared. Context menu scenarios are limited to Doubao pages again.',
      ...
      expertModeDescription: 'Only affects chat.doubao.com conversations. Sidepanel API chat chooses the model on the Chat page. (B-01) Skipped when you upload files or have already picked a model in the web UI.',
      ...
      // B-14: shell host install guidance.
      shellHostSection: 'Shell host (advanced)',
      extensionId: 'Current extension ID',
      shellHostName: 'Native host name',
      shellHostNameHint: 'Override only if you are running a local unpacked build and installed the shell host under a different name. Default: com.doubao_wplus.shell',
      shellHostSaved: 'Saved. New MCP server presets will use this host name.',
      shellHostCleared: 'Cleared. The default host name (com.doubao_wplus.shell) will be used.',
      shellHostError: 'Failed to save. Try again.',
      shellHostInstallCommand: 'Install command',
      shellHostInstallHint: 'Run this in a terminal after saving the host name above. The Chrome Web Store build does not need this — the host is registered automatically on install.',
      petWhale: 'Doubao whale',
      petWhaleDescription: 'Show a state-aware pet on Doubao pages',
      backgroundSection: 'Background settings',
      customBackground: 'Custom background',
      customBackgroundDescription: 'Set a background image for Doubao pages',
      ...
      petIcon: 'Pet icon',
      petIconUpload: 'Upload icon',
      petIconClear: 'Reset default',
      petIconHint: 'Upload a custom image as the pet icon (centered automatically)',
      ...
      githubPlaceholder: 'https://github.com/your/repository',
      githubEmpty: 'No GitHub repository set yet (enter your own repo above)',
    },
    promptControls: {
      title: 'Prompt controls',
      memory: 'Memory injection',
      memoryDescription: 'Include selected long-term memories in new requests',
      systemPrompt: 'WPlus system prompt',
    ...
    browserControlPage: {
      ...
      description: 'Let WPlus control a selected Chrome or Edge tab through the browser debugger and Accessibility Tree.',
    ...
    mcpPage: {
      title: 'MCP',
      description: 'Connect local or remote MCP services so WPlus can discover tools, control auto execution, and return results.',
      ...
      detail: {
        ...
        injectionSummary: '{count} tools are currently injected. Disabled or manual strategy will not enter the Doubao Prompt.',
    ...
    chatPage: {
      ...
      inputPlaceholder: 'Message WPlus',
      send: 'Send',
      modelLabel: 'Model',
      modelFlash: 'Flash',
      modelPro: 'Pro',
      ...
      effortHigh: 'Standard',
      effortMax: 'Max',
      tokenSpeedTitle: 'Output: {speed} tok/s · ~{tokens} tokens{idle}',
      tokenSpeedIdle: ' (idle)',
    ...
    toolsPage: {
      diagnosticsDefaultQuery: 'Doubao latest news',
    ...
    automationPage: {
      title: 'Automation',
      description: 'Run fixed tasks in dedicated Doubao conversations, either manually or on a Cron / RRULE schedule.',
      ...
      form: {
        ...
        promptPlaceholder: 'Enter the content to send to Doubao on schedule',
        trigger: 'Trigger',
        manual: 'Manual',
  ...
  content: {
    ...
    historyOrganizer: {
      enhancedSearchTitle: 'WPlus search enhancements',
      ...
      emptySearchStatus: 'WPlus: waiting for official search results',
      visibleStatus: 'WPlus: {visible}/{total} visible',
      loadError: 'WPlus: failed to load history tags: {message}',
      saveError: 'WPlus: failed to save history tags: {message}',
    },
    projectSidebar: {
      title: 'Projects',
    ...
    toolBlock: {
      ...
      missingResultDetail: 'Background did not return a tool result. Refresh the current Doubao page and try again.',
      missingSandboxResultDetail: 'The sandbox tool did not return an execution result. Reload the WPlus extension and refresh the current Doubao page, then try again; it does not depend on MCP or Shell Local.',
      missingMcpResultDetail: 'Background did not return an MCP tool result. Refresh the current Doubao page and try again. If it still fails, retest Shell Local on the MCP page.',
    ...
    permission: {
      webFetch: 'WPlus needs permission to access {origin} so it can fetch that page',
      deny: 'Deny',
      grant: 'Allow',
    ...
    extensionReloaded: 'The extension was reloaded. Refresh the current Doubao page and try again.',
  },
  background: {
    contextMenus: {
    ...
    auth: {
      missingDoubao: 'Sign in at chat.doubao.com first, or refresh the Doubao page and try again.',
    },
    export: {
  ...
  tool: {
    ...
    web: {
      ...
      permissionDenied: 'The extension does not have permission to access Bing. Remove and reload the dist/chrome-mv3 extension directory, or confirm cn.bing.com is listed under site access in chrome://extensions -> WPlus details.',
    ...
    sandbox: {
      ...
      runDescription: 'Execute JavaScript, TypeScript, Python, or HTML in an isolated extension sandbox, not in the Doubao page.',
    ...
    browser: {
      providerName: 'WPlus Browser Control',
